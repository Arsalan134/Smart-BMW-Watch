...
extern const st77916_lcd_init_cmd_t vendor_specific_init_default[];
extern const size_t vendor_specific_init_default_size;
extern const st77916_lcd_init_cmd_t vendor_specific_init_version_2[];
extern const size_t vendor_specific_init_version_2_size;
